...
export default function ArchitecturePanel({ architecture }) {
  return (
    <div className="card" style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: "12px" }}>
      <div>
        <span className="eyebrow" style={{ color: "var(--teal)" }}>System Blueprint</span>
        <h3 style={{ margin: "2px 0 0 0", fontSize: "18px" }}>Selected Architecture Solution</h3>
      </div>
      <motion.div
