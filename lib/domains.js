...
export const DOMAINS = [
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "Rendering: CSR vs SSR vs SSG", status: "soon" },
  ...
  },
  {
    ...
    topics: [
      { t: "Two Pointers", status: "soon" },
      { t: "Sliding Window", status: "soon" },
      { t: "Binary Search", status: "soon" },
      { t: "Trees, BFS & DFS", status: "soon" },
      { t: "Graphs", status: "soon" },
      { t: "Dynamic Programming", status: "soon" },
      { t: "Heaps, Tries & Union-Find", status: "soon" },
      { t: "How to recognize the pattern", status: "soon" },
    ],
  },
  {
    id: "devops",
    ...
    topics: [
      ...
      { t: "CI/CD pipelines", status: "soon" },
      { t: "Docker & containers", status: "soon" },
      { t: "Kubernetes & orchestration", status: "soon" },
      { t: "Observability — logs, metrics, traces", status: "soon" },
  ...
  },
  {
    ...
    topics: [
      { t: "What 'the cloud' actually is", status: "soon" },
  ...
  },
  {
    ...
    topics: [
      ...
      { t: "Embeddings & vector search", status: "soon" },
      { t: "RAG — grounding an LLM", status: "soon" },
