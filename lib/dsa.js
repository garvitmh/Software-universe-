...
import { WAVE9A } from "./dsa/wave9a";
import { WAVE9B } from "./dsa/wave9b";
import { WAVE9C } from "./dsa/wave9c";
import { WAVE10A } from "./dsa/wave10a";
import { WAVE10B } from "./dsa/wave10b";
import { WAVE10C } from "./dsa/wave10c";
import { WAVE11A } from "./dsa/wave11a";
import { WAVE11B } from "./dsa/wave11b";
import { WAVE11C } from "./dsa/wave11c";
import { WAVE12A } from "./dsa/wave12a";
import { WAVE12B } from "./dsa/wave12b";
import { WAVE12C } from "./dsa/wave12c";
import { WAVE13A } from "./dsa/wave13a";
import { WAVE13B } from "./dsa/wave13b";
import { WAVE13C } from "./dsa/wave13c";
import { WAVE14A } from "./dsa/wave14a";
import { WAVE14B } from "./dsa/wave14b";
import { WAVE14C } from "./dsa/wave14c";
import { WAVE15A } from "./dsa/wave15a";
import { WAVE15B } from "./dsa/wave15b";
import { WAVE15C } from "./dsa/wave15c";
import { WAVE16A } from "./dsa/wave16a";
import { WAVE16B } from "./dsa/wave16b";
import { WAVE16C } from "./dsa/wave16c";
import { WAVE17A } from "./dsa/wave17a";
import { WAVE17B } from "./dsa/wave17b";
import { WAVE17C } from "./dsa/wave17c";
import { WAVE18A } from "./dsa/wave18a";
import { WAVE18B } from "./dsa/wave18b";
import { WAVE18C } from "./dsa/wave18c";
import { WAVE19A } from "./dsa/wave19a";
import { WAVE19B } from "./dsa/wave19b";
import { WAVE19C } from "./dsa/wave19c";
...
export const DSA_PROBLEMS = [
  ...
  ...(typeof WAVE9A !== "undefined" ? WAVE9A : []),
  ...(typeof WAVE9B !== "undefined" ? WAVE9B : []),
  ...(typeof WAVE9C !== "undefined" ? WAVE9C : []),
  ...(typeof WAVE10A !== "undefined" ? WAVE10A : []),
  ...(typeof WAVE10B !== "undefined" ? WAVE10B : []),
  ...(typeof WAVE10C !== "undefined" ? WAVE10C : []),
  ...(typeof WAVE11A !== "undefined" ? WAVE11A : []),
  ...(typeof WAVE11B !== "undefined" ? WAVE11B : []),
  ...(typeof WAVE11C !== "undefined" ? WAVE11C : []),
  ...(typeof WAVE12A !== "undefined" ? WAVE12A : []),
  ...(typeof WAVE12B !== "undefined" ? WAVE12B : []),
  ...(typeof WAVE12C !== "undefined" ? WAVE12C : []),
  ...(typeof WAVE13A !== "undefined" ? WAVE13A : []),
  ...(typeof WAVE13B !== "undefined" ? WAVE13B : []),
  ...(typeof WAVE13C !== "undefined" ? WAVE13C : []),
  ...(typeof WAVE14A !== "undefined" ? WAVE14A : []),
  ...(typeof WAVE14B !== "undefined" ? WAVE14B : []),
  ...(typeof WAVE14C !== "undefined" ? WAVE14C : []),
  ...(typeof WAVE15A !== "undefined" ? WAVE15A : []),
  ...(typeof WAVE15B !== "undefined" ? WAVE15B : []),
  ...(typeof WAVE15C !== "undefined" ? WAVE15C : []),
  ...(typeof WAVE16A !== "undefined" ? WAVE16A : []),
  ...(typeof WAVE16B !== "undefined" ? WAVE16B : []),
  ...(typeof WAVE16C !== "undefined" ? WAVE16C : []),
  ...(typeof WAVE17A !== "undefined" ? WAVE17A : []),
  ...(typeof WAVE17B !== "undefined" ? WAVE17B : []),
  ...(typeof WAVE17C !== "undefined" ? WAVE17C : []),
  ...(typeof WAVE18A !== "undefined" ? WAVE18A : []),
  ...(typeof WAVE18B !== "undefined" ? WAVE18B : []),
  ...(typeof WAVE18C !== "undefined" ? WAVE18C : []),
  ...(typeof WAVE19A !== "undefined" ? WAVE19A : []),
  ...(typeof WAVE19B !== "undefined" ? WAVE19B : []),
  ...(typeof WAVE19C !== "undefined" ? WAVE19C : []),
];
...
export const DSA_STATS = {
  ...
  // The roadmap target — the full NeetCode "All" set (~700).
  target: 700,
};
